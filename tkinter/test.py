...
class HexaCanvas(Canvas):
    ...
    def create_hexagone(self, x, y, color = "black", fill="white"):
        """ 
        ...
        self.create_line(point1, point2, fill=color, width=2)
        self.create_line(point2, point3, fill=color, width=2)
        self.create_line(point3, point4, fill=color, width=2)
        self.create_line(point4, point5, fill=color, width=2)
        self.create_line(point5, point6, fill=color, width=2)
        self.create_line(point6, point1, fill=color, width=2)
